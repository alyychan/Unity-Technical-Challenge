...
public class DrawSkeleton : MonoBehaviour
{
    ...
    private void InitializeSkeleton()
    {
        ...
        // Head
        InitializeLine(0, 8, 9, lineWidth, Color.magenta);
        InitializeLine(1, 7, 8, lineWidth, Color.magenta);
        // Body
        InitializeLine(2, 12, 13, lineWidth, Color.red);
        InitializeLine(3, 3, 13, lineWidth, Color.red);
        InitializeLine(4, 2, 12, lineWidth, Color.red);
        InitializeLine(5, 2, 3, lineWidth, Color.red);
        // Arms
        InitializeLine(6, 13, 14, lineWidth, Color.green);
        InitializeLine(7, 14, 15, lineWidth, Color.green);
        InitializeLine(8, 11, 12, lineWidth, Color.green);
        InitializeLine(9, 10, 11, lineWidth, Color.green);
        // Legs
        InitializeLine(10, 3, 4, lineWidth, Color.blue);
        InitializeLine(11, 4, 5, lineWidth, Color.blue);
        InitializeLine(12, 1, 2, lineWidth, Color.blue);
        InitializeLine(13, 0, 1, lineWidth, Color.blue);
    }
